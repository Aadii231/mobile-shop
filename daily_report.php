...
if(isset($admin_id))
{
    ...
    ?>
<h1 class="text text-capitalize text-center " style="color: black;font-family: cursive"><b>View Daily Reports</b></h1>
...
{
    $date=$_POST['date'];
  $query="SELECT * FROM `sold_mobile` where date='$date' ";
